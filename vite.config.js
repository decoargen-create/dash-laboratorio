    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          ...
          start_url: '/acceso',
          icons: [
            { src: '/adslab-favicon.svg', sizes: 'any', type: 'image/svg+xml', purpose: 'any' },
            { src: '/adslab-pwa-192.png', sizes: '192x192', type: 'image/png', purpose: 'any maskable' },
            { src: '/adslab-pwa-512.png', sizes: '512x512', type: 'image/png', purpose: 'any maskable' },
          ],
        },
      }),
    ],
